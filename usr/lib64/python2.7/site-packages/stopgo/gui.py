...
class GUI(wx.Frame):
    ...
    def OnLeftClick(self,e):
        ...
        print('left') #debug
        if self.hasSelected:
            print('selection detected, removing flag') #debug
    ...
    def OnLeftRelease(self,e):
        ...
        print("clickity Release Left click") #debug
        self.player.stop()
        ...
        if not self.hasSelected:
            ...
            # TODO parallel this with python threading?
